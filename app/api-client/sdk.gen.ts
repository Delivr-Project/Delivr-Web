...
/**
 * Get mail list page size
 *
 * Retrieve the authenticated user's preferred number of mails shown per page in a mailbox list.
 */
export const getAccountPreferencesMailListPageSize = <TComposable extends Composable = '$fetch', DefaultT extends GetAccountPreferencesMailListPageSizeResponse = GetAccountPreferencesMailListPageSizeResponse>(options: Options<TComposable, GetAccountPreferencesMailListPageSizeData, GetAccountPreferencesMailListPageSizeResponse, DefaultT>) => (options.client ?? client).get<TComposable, GetAccountPreferencesMailListPageSizeResponse | DefaultT, unknown, DefaultT>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
/**
 * Set mail list page size
 *
 * Replace the authenticated user's preferred number of mails shown per page in a mailbox list.
 */
export const putAccountPreferencesMailListPageSize = <TComposable extends Composable = '$fetch', DefaultT extends PutAccountPreferencesMailListPageSizeResponse = PutAccountPreferencesMailListPageSizeResponse>(options: Options<TComposable, PutAccountPreferencesMailListPageSizeData, PutAccountPreferencesMailListPageSizeResponse, DefaultT>) => (options.client ?? client).put<TComposable, PutAccountPreferencesMailListPageSizeResponse | DefaultT, PutAccountPreferencesMailListPageSizeError, DefaultT>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/account/preferences/mail-list-page-size',
    ...options,
    headers: {
